...
class NatureQN(Linear):
    ...
    def initialize_models(self):
        ...
        ### START CODE HERE ###
        # Define the correct number of input channels
        inChannels = n_channels*self.config["hyper_params"]["state_history"]

        # Define the convolutional layers
        self.q_network = nn.Sequential(
            nn.Conv2d(inChannels, 32, kernel_size=8, stride=4, padding=2),  # pad 2
            nn.ReLU(),
    ...
    def get_q_values(self, state, network):
        ...
        ### START CODE HERE ###
        # Assign network based on str arg
