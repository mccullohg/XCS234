...
class PolicyGradient(object):
    ...
    def init_policy(self):
        ...
        # Build network
        self.network = build_mlp(input_size=self.observation_dim,
    ...
    def get_returns(self, paths):
        ...
        all_returns = []
        gamma = self.config["hyper_params"]["gamma"]  # discount rate
        ...
        for path in paths:
            ...
            # Calculate discounted returns according to Eq above
    ...
    def normalize_advantage(self, advantages):
        ...
        stddev = np.std(advantages)
        normalized_advantages = (advantages-mean)/stddev
        ### END CODE HERE ###
    ...
    def update_policy(self, observations, actions, advantages):
        ...
        plog = action_distribution.log_prob(actions)
        loss = -(plog*advantages).mean()

        # Optimize the policy (as necessary)
